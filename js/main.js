...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if(document.querySelectorAll('#map').length > 0) {
    ...
    js_file.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDm-8SDNJLWOoOgh6f52eS3fQ0fmkYeIcY&callback=initMap&language=' + lang;
...
// document.addEventListener("DOMContentLoaded", function () {
  ...
  // if(document.querySelectorAll("#map").length > 0) {
    ...
    // js_file.async = true;
    // js_file.defer = true;
    // js_file.src = "https://maps.googleapis.com/maps/api/js?libraries=places,geometry,drawing&key=AIzaSyDm-8SDNJLWOoOgh6f52eS3fQ0fmkYeIcY&v=3&callback=initMap";
    // document.getElementsByTagName("head")[0].appendChild(js_file);
  // }
// });
